                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/dbtutechan/upload/shangpinOrderMuBan.xls"
                        >批量导入商品订单数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangpinOrder','导入导出')"
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.shangpinAddress!= '' && this.searchForm.shangpinAddress!= undefined) {
                    params['shangpinAddress'] = '%' + this.searchForm.shangpinAddress + '%'
                }
                ...
                if (this.searchForm.bangfuTypes!= '' && this.searchForm.bangfuTypes!= undefined) {
                    params['bangfuTypes'] = this.searchForm.bangfuTypes
                }
                ...
                this.$http({
                    url: "dictionary/page?dicCode=bangfu_types&page=1&limit=100",
                    method: "get",
                    page: 1,
                    limit: 100,
                }).then(({data}) => {
                    if(data && data.code === 0){
                        this.bangfuTypesSelectSearch = data.data.list;
                    }
                });
                this.$http({
